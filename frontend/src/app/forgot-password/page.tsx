    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 w-full max-w-md">
        <div className="mb-8">
          ...
          <p className="text-gray-500 text-sm mt-1.5">Must be at least 8 characters.</p>
        </div>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-3.5 py-2.5 pr-10 rounded-lg border border-gray-200 text-sm text-gray-900
